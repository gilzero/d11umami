...
#[Source(
  id: 'view_field',
  label: new TranslatableMarkup('View field'),
...
class ViewFieldSource extends ViewsSourceBase {
  ...
  public function getPropValue(): mixed {
    ...
    $view = $this->getView();
    $options = $this->getViewsFieldOptions($view);
    ...
    if (empty($field_name) || !$view || !($view instanceof ViewExecutable) || !is_array($options) || !array_key_exists($field_name, $options)) {
      return ['#markup' => ''];
    }
    ...
    return $this->renderOutput($field_output);
  }
  ...
  public function settingsForm(array $form, FormStateInterface $form_state): array {
    ...
    $options = $this->getViewsFieldOptions($this->getView());
